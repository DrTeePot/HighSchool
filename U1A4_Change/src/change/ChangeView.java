...
public class ChangeView extends FrameView {
    ...
    private void initComponents() {
        ...
        TooniesLable = new javax.swing.JLabel();
        ...
        TooniesLable.setText(resourceMap.getString("TooniesLable.text")); // NOI18N
        TooniesLable.setName("TooniesLable"); // NOI18N
                            ...
                            .addGroup(mainPanelLayout.createSequentialGroup()
                                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, mainPanelLayout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(outputAmount, javax.swing.GroupLayout.DEFAULT_SIZE, 211, Short.MAX_VALUE))
                                    .addGroup(mainPanelLayout.createSequentialGroup()
                                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(TooniesLable)
                                            .addComponent(LooniesLabel))
                                        .addGap(18, 18, 18)
                                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addComponent(outputLoonies, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(outputToonies, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void CalculateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculateButtonActionPerformed
        ...
        // get user input from a field, and then turn it into the total cents.
           // using cents allows all calculations to be integer calculations.
        amountIn = inputField.getText();
        convertIn = Double.parseDouble(amountIn)*100;
        total = (int)convertIn;

        // calculations are completed and assigned to variables.
        toonies = (total/200);
        ...
        //output each integer to the screen for the user. each value is an integer number and doesn't require 
            // any formating. 
    ...
    private javax.swing.JLabel TooniesLable;
